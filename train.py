            ...
            for phase in ['train', 'val']:
                ...
                for i, data in tqdm(enumerate(dataloaders[phase]), desc='Dataiteration'):
                    ...
                    if i % 100 == 0:
                        ...
                        if phase == 'train':
                            plotter.plot('loss', 'itr', 'train', 'Class Loss', (epoch+1)*i,
                                          loss_av)
                            plotter.plot('acc', 'train', 'itr', 'Class Acc', (epoch+1)*i,
                                          acc_av)

                        if phase == 'val':
                            plotter.plot('loss', 'val', 'itr', 'Class Loss', (epoch+1)*i,
                                          loss_av)
                            plotter.plot('acc', 'val', 'itr', 'Class Acc', (epoch+1)*i,
                                          acc_av)
